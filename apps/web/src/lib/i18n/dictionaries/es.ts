...
export const es: Dictionary = {
  ...
  patient: {
    ...
    welcome_title: "Analisis de Piel",
    welcome_description:
      "Descubre tu tipo de piel y recibe recomendaciones personalizadas de tratamiento en menos de 3 minutos.",
    welcome_cta: "Iniciar Analisis",
    welcome_subtext: "Gratis y sin registro",

    consent_title: "Consentimiento",
    consent_body:
      "Para realizar el analisis, necesitaremos una foto de tu rostro. Esa foto sera procesada por inteligencia artificial para identificar caracteristicas de tu piel.",
    consent_data_protected: "Tus datos estan protegidos:",
    consent_li_1: "La foto se procesa y descarta de inmediato",
    consent_li_2: "No almacenamos imagenes faciales",
    consent_li_3: "El analisis es anonimo por defecto",
    consent_li_4: "Puedes proporcionar tu email opcionalmente para recibir el reporte",
    consent_lgpd: "En cumplimiento con la proteccion de datos personales aplicable.",
    consent_back: "Volver",
    consent_cta: "Acepto y continuar",

    results_header_eyebrow: "Resultado del Analisis",
    results_your_skin_is: "Tu piel es",
    results_observation_label: "Observacion sobre tu tipo de piel",
    results_observation_intro:
      "Indicaste que tu piel es {self}, pero nuestro analisis identifico que tu piel es {detected}.",
    results_face_map: "Mapa Facial",
    results_skin_radar: "Radar de la Piel",
    results_attention: "Atencion",
    results_healthy: "Saludable",
    results_care: "Cuidado",
    results_zone_tap_hint: "Toca los marcadores para ver detalles de cada zona",
    results_zone_forehead: "Frente",
    results_zone_nose: "Nariz",
    results_zone_left_cheek: "Mejilla Izq.",
    results_zone_right_cheek: "Mejilla Der.",
    results_zone_chin: "Menton",
    results_zone_under_eyes: "Ojeras",
    results_zone_jawline: "Mandibula",
    results_phases_title: "Tu cuidado en 3 fases",
    results_phase_starting: "Comenzando",
    results_phase_progressing: "Avanzando",
    results_phase_maintaining: "Manteniendo",
    results_phase_weeks_1_2: "Semanas 1-2",
    results_phase_weeks_3_8: "Semanas 3-8",
    results_phase_month_3: "Mes 3+",
    results_close: "cerrar",
    results_section_conditions: "Lo que observamos en tu piel",
    results_section_products: "Productos Recomendados",
    results_section_services: "Servicios Recomendados",
    results_section_alert: "Cuando consultar un dermatologo",
    results_alert_closing: "Si presentas cualquiera de estos signos, consulta un dermatologo.",
    results_section_kit: "Kit de tratamiento",
    results_kit_title: "Todos tus productos en un solo enlace",
    results_kit_description: "Comparte tu kit personalizado o accede a el en cualquier momento.",
    results_kit_share: "Compartir Kit",
    results_kit_view: "Ver Kit Completo",
    results_email_section: "Recibe el reporte completo",
    results_email_placeholder: "tu@email.com",
    results_email_send: "Enviar",
    results_email_sending: "Enviando...",
    results_email_sent: "Email enviado.",
    results_download_pdf: "Descargar reporte en PDF",
    results_downloading_pdf: "Generando PDF...",
    results_disclaimer_default:
      "Este analisis es solo informativo y no sustituye la consulta con un dermatologo.",
    ...
    results_cart_add: "Agregar",
    results_cart_added: "En el carrito",
    results_buy_default: "Comprar",
    results_buy_whatsapp: "Comprar por WhatsApp",
    results_buy_mercadopago: "Pagar con MercadoPago",
    results_buy_external: "Comprar",
    results_book_service: "Agendar",
    results_step_cleanser: "Limpieza",
    results_step_toner: "Tonico",
    results_step_serum: "Serum",
    results_step_moisturizer: "Hidratante",
    results_step_spf: "Protector Solar",
    results_step_treatment: "Tratamiento",
    results_step_mask: "Mascarilla",
    results_step_exfoliant: "Exfoliante",
    results_step_eye_cream: "Contorno de ojos",
    results_use_morning: "manana",
    results_use_night: "noche",
    results_use_morning_night: "manana y noche",
    results_use_apply:
      "Aplica segun las instrucciones del producto.",
    results_use_template: "Usar en la etapa de {step}, {time}. {apply}",
    results_indicated_for: "Indicado para piel",
    results_aligned_objective: "Alineado con tu objetivo:",
    results_severity_light: "Leve",
    results_severity_moderate: "Moderado",
    results_severity_severe: "Severo",
    results_barrier_section: "Estado de tu piel",

    cart_count_one: "{n} item",
    cart_count_many: "{n} items",
    cart_total: "Total",
    cart_add_routine: "Agregar rutina completa",
    cart_finalize: "Finalizar",
    cart_clear: "Vaciar carrito",
    cart_clear_confirm:
      "Ya tienes items de {current}. Agregar este item de {target} reemplazara el carrito. ¿Confirmar?",
  },
