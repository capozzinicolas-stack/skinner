...
export default function AnalysisPage({
  ...
  // right language. tenant.data?.effectiveLocale falls through to "pt-BR"
  // when missing — same chain the I18nProvider below uses, just precomputed
  // so we can read t.patient.* outside the provider (this component owns
  // both the inline welcome/consent JSX AND the provider).
