...
const COPY: Record<Locale, HomeCopy> = {
  "pt-BR": {
    ...
    segments: [
      ...
      { num: "IV", title: "Varejo", desc: "Análise no e-commerce ou loja. O cliente entende o que precisa e finaliza no carrinho com mais confiança e ticket maior.", href: "/varejo", feat: false },
    ],
  ...
  es: {
    ...
    segments: [
      { num: "I", title: "Laboratorios", desc: "Tu catálogo convertido en recomendación personalizada en miles de puntos de contacto — directo con el consumidor final.", href: "/laboratorios", feat: false },
      { num: "II", title: "Clínicas", desc: "Diagnóstico IA antes de la consulta: el paciente llega 70% más informado y la venta del tratamiento fluye mucho más.", href: "/clinicas", feat: true },
      { num: "III", title: "Farmacias", desc: "Tablet en mostrador. Análisis en 3 minutos. Ticket promedio de skincare 2.4x mayor comparado con clientes sin análisis.", href: "/farmacias", feat: false },
      { num: "IV", title: "Retail", desc: "Análisis en el e-commerce o tienda. El cliente entiende qué necesita y finaliza en el carrito con más confianza y ticket mayor.", href: "/varejo", feat: false },
    ],
    segmentsCta: "Ver caso →",
  ...
  en: {
    ...
    segments: [
      { num: "I", title: "Laboratories", desc: "Your catalog turned into personalized recommendation across thousands of touchpoints — directly with the end consumer.", href: "/laboratorios", feat: false },
      { num: "II", title: "Clinics", desc: "AI diagnosis before the consultation: the patient arrives 70% more informed and the treatment sale flows much better.", href: "/clinicas", feat: true },
      { num: "III", title: "Pharmacies", desc: "Tablet at the counter. 3-minute analysis. Skincare AOV 2.4x higher than customers without analysis.", href: "/farmacias", feat: false },
      { num: "IV", title: "Retail", desc: "Analysis in the e-commerce or store. The customer understands what they need and checks out with more confidence and a higher ticket.", href: "/varejo", feat: false },
    ],
