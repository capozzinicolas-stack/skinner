    ...
    <>
      ...
      <section className="py-24 px-8">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="text-lg font-light text-terre mt-6 leading-relaxed max-w-[620px]">
            Quatro etapas. Três minutos. Um diagnóstico que fecha venda. Veja por dentro do
            motor de IA, do relatório do paciente e do painel do gestor.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-20 items-center">
          <div>
            ...
            <h2 className="font-serif text-[clamp(32px,4.2vw,52px)] leading-[1.08] text-carbone mb-6">
              Foto, questionário, <i className="text-terre">contexto</i>.
            </h2>
            <p className="text-base font-light text-pierre leading-relaxed mb-6">
              Em qualquer canal — site, tablet do PDV, WhatsApp, app da clínica. Captura
              otimizada por orientação visual de iluminação e enquadramento.
            </p>
          ...
          <div className="bg-white border border-pierre/25 shadow-[0_24px_60px_-30px_rgba(28,25,23,0.18)] overflow-hidden">
            ...
            <div className="p-8 flex gap-6">
              <div className="relative w-[48%] min-h-[380px] bg-ivoire">
                ...
                <span className="absolute bottom-4 left-4 font-mono text-[9px] text-terre">ILUMINAÇÃO ✓</span>
                <span className="absolute bottom-4 right-4 font-mono text-[9px] text-terre">ÂNGULO ✓</span>
              </div>
              <div className="flex-1">
                <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-pierre mb-1">Questionário · 3/7</p>
                <h3 className="font-serif text-[22px] italic text-carbone mt-1.5 mb-[18px]">Como sua pele se comporta no fim do dia?</h3>
                {["Brilha em testa, nariz e queixo", "Brilha em todo o rosto", "Fica repuxada, sem brilho", "Sem alteração"].map((q, i) => (
      ...
      <section className="py-24 px-8 bg-white">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-20 items-center">
          <div className="order-2 lg:order-1">
            <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-pierre mb-4">02 — Análise</p>
            <h2 className="font-serif text-[clamp(32px,4.2vw,52px)] leading-[1.08] text-carbone mb-6">
              IA proprietária treinada em <i className="text-terre">847k</i> imagens.
            </h2>
            <p className="text-base font-light text-pierre leading-relaxed mb-6">
              Modelo dermatológico próprio, validado clinicamente, que classifica condições
              em escala de 5 níveis e gera um match score por produto do seu catálogo.
            </p>
      ...
      <section className="py-28 bg-ivoire border-t border-sable/40">
        <div className="max-w-[1200px] mx-auto px-8 text-center">
          ...
          <h2 className="font-serif text-[clamp(32px,4.2vw,52px)] leading-[1.08] text-carbone mb-6">
            Veja na <i className="text-terre">prática</i>.
          </h2>
