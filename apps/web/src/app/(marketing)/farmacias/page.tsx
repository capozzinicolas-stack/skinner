    ...
    <>
      <section className="py-24 px-8">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-pierre mb-4">Segmento · Farmacias</p>
          <h1 className="font-serif text-[clamp(48px,7vw,84px)] leading-[1.02] tracking-[-0.015em] text-carbone">
            Tablet no balcao. Ticket medio <i className="text-terre">2.4x</i> maior.
          </h1>
          <p className="text-lg font-light text-terre mt-6 leading-relaxed max-w-[620px]">
            Analise no PDV em 3 minutos. O atendente consulta junto com o cliente e a recomendacao
            aparece em tempo real, com produtos disponiveis no estoque local.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-20 items-start">
          <div>
            <ul className="flex flex-col gap-3 mb-8">
              {["Modo PDV otimizado pra tablet", "Integracao com Linx, RM, e PDVs proprios", "Comissao automatica para atendente", "Treinamento por video + certificacao"].map((b, i) => (
          ...
          <div className="p-8 border border-sable/30 bg-white">
            ...
            <div className="space-y-6">
              {[["2.4x", "ticket medio skincare"], ["+62%", "cross-sell por atendimento"], ["89%", "taxa de aceite da recomendacao"]].map(([n, l], i) => (
