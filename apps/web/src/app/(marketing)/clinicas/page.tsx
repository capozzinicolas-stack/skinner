    ...
    <>
      <section className="py-24 px-8">
        <div className="max-w-[1200px] mx-auto">
          <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-pierre mb-4">Segmento · Clinicas</p>
          <h1 className="font-serif text-[clamp(48px,7vw,84px)] leading-[1.02] tracking-[-0.015em] text-carbone">
            O paciente chega educado. A venda <i className="text-terre">flui</i>.
          </h1>
          <p className="text-lg font-light text-terre mt-6 leading-relaxed max-w-[620px]">
            Analise IA antes da consulta dermatologica. O paciente entra no consultorio ja entendendo o estado
            da pele, com expectativas alinhadas e mais aberto a recomendacao de tratamento e venda de produto.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-20 items-start">
          <div>
            <ul className="flex flex-col gap-3 mb-8">
              {["Marca branca completa", "Integracao com prontuario (memed, doctor.med)", "Receituario e PDF assinados", "Historico de evolucao do paciente"].map((b, i) => (
          ...
          <div className="p-8 border border-sable/30 bg-white">
            ...
            <div className="space-y-6">
              {[["3.1x", "venda de produto por consulta"], ["-40%", "tempo da consulta inicial"], ["NPS 71", "satisfacao do paciente"]].map(([n, l], i) => (
